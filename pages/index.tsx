...
export default function Home() {
  ...
  const [logoVal, setLogoVal] = useState(`${process.env.NEXT_PUBLIC_URL}/assets/smiling-face.png`); // http://localhost:3000 || https://wynekayuliana.github.io/qrcode-generator
